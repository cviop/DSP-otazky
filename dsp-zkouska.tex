...
\usepackage[left=2.5cm,right=1.5cm,top=2cm,bottom=2.5cm]{geometry} %okraje stranky
...
\begin{center}
    ...
    {\normalfont Verze \today,~\currenttime. Nejnovější verzi najdete vždy na \url{https://github.com/cviop/DSP-otazky/blob/main/dsp-zkouska.pdf}}\\
\end{center}
